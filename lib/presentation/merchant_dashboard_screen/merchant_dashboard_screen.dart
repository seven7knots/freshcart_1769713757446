...
class _MerchantDashboardScreenState extends State<MerchantDashboardScreen> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 3.h),
            Text('No Merchant Account',
                style: TextStyle(
                    fontSize: 18.sp, fontWeight: FontWeight.bold)),
            SizedBox(height: 1.h),
            Text('You need to apply as a merchant first',
          ...
          Expanded(
            child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 0.5.h),
                  Text(merchant.address ?? 'No address set',
                      style: TextStyle(
                          fontSize: 12.sp,
                          color: theme.colorScheme.onSurfaceVariant),
                      maxLines: 1,
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(children: [
          ...
          SizedBox(height: 1.h),
          Text('Create your first store to start selling',
              textAlign: TextAlign.center,
              style: TextStyle(
                  fontSize: 12.sp,
                  color: theme.colorScheme.onSurfaceVariant)),
  ...
  Widget _buildStoreCard(Map<String, dynamic> store) {
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () =>
            _navigateToStoreManagement(store['id'] as String),
        borderRadius: BorderRadius.circular(12),
        child: Padding(
          padding: EdgeInsets.all(3.w),
          child: Row(children: [
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Row(children: [
                      ...
                      SizedBox(width: 1.w),
                      Text('${store['total_reviews'] ?? 0} orders',
                          style: TextStyle(
                              fontSize: 11.sp,
                              color:
  ...
  // ============================================================
  // CREATE STORE DIALOG — with Map Picker
  // ============================================================
          ...
          builder: (ctx, setDialogState) => SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                // Store location + delivery radius via map picker
                GestureDetector(
                  onTap: () async {
                  ...
                  child: AbsorbPointer(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        labelText: 'Store Location & Delivery Zone',
              ...
              return ElevatedButton(
                onPressed: merchantProvider.isLoading
                    ...
                    : () async {
                        ...
                        // Update store with location if picked
                        if (store != null &&
                            storeLat != null &&
                            store['id'] != null) {
                          try {
